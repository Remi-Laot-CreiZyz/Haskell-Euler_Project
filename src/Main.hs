...
main = do
    ...
    -- EXERCICE 2:
    -- Find the sum of even terms from fibonacci sequence that are smaller than four million
    ...
    time $ putStrLn (". the numbers in fibonacci sequence that are smaller than 4M are " ++                show (takeWhile (<4000000) fibonacciSequence)                                                ++ ".")
    time $ putStrLn (". the sum of even numbers in fibonacci sequence that are smaller than 4M is " ++     show (sum $ takeWhile (<4000000) (filter even fibonacciSequence))                            ++ ".")
    putStrLn "..."
